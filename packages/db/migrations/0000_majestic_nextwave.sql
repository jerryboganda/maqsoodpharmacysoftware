...
ALTER TABLE `gl_account_category` ADD CONSTRAINT `gl_account_category_gl_account_main_id_gl_account_main_gl_account_main_id_fk` FOREIGN KEY (`gl_account_main_id`) REFERENCES `gl_account_main`(`gl_account_main_id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `gl_account_sub` ADD CONSTRAINT `gl_account_sub_gl_account_category_id_gl_account_category_gl_account_category_id_fk` FOREIGN KEY (`gl_account_category_id`) REFERENCES `gl_account_category`(`gl_account_category_id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
